...
function init() {
  try {
    ...
    const duckTexture = textureLoader.load('./maga.png');
    ...
    duckMesh.position.set(0, 2, 10); // Positioned midway in the room
    duckMesh.rotation.y = Math.PI; // Face the player
    scene.add(duckMesh);
